impor    17: [
    {
        "question": "TRUE or FALSE?\nThe Union Flag consists of four crosses, one for each part of the United Kingdom.",
        "translation": "🇷🇺 Верно или нет?\nФлаг UK состоит из четырёх крестов — по одному на каждую часть.",
        "options": ["TRUE", "FALSE"],
        "answer": 1,
        "explanation": (
            "❌ *Неверно! / False!*\n\n"
            "📖 The Union Flag consists of three crosses — the crosses of St George (England), St Andrew (Scotland) and St Patrick (Ireland).\n\n"
            "🇷🇺 *Перевод:* Флаг UK состоит из трёх крестов: Св. Георгия, Св. Андрея и Св. Патрика."
        ),
    },
    {
        ...
        "options": [
            "A — To apply to become a permanent resident or naturalised citizen of the UK, you must have a UK bank account.",
            "B — To apply to become a permanent resident or naturalised citizen of the UK, you must be able to speak and read English."
        ],
        "answer": 1,
        "explanation": (
            "✅ *Верно — B!*\n\n"
            ...
            "🇷🇺 *Перевод:* Для ПМЖ/гражданства нужно знание английского и жизни в UK — не банковский счёт."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Женщины составляют около половины рабочей силы Британии."
        ),
    },
    {
        "question": "Which of the following rights did Acts of Parliament in 1870 and 1882 give married women?",
        "translation": "🇷🇺 Какие права дали замужним женщинам законы 1870 и 1882 годов?",
        "options": [
            "A — The right to vote and the right to free healthcare",
            "B — The right to vote and the right to keep their own earnings",
            "C — The right to keep their own earnings and property",
            "D — The right to free secondary school education and the right to vote"
        ],
        "answer": 2,
        "explanation": (
            "✅ *Верно — C!*\n\n"
            "📖 Until 1870, when a woman got married, her earnings and property automatically belonged to her husband. Acts of Parliament in 1870 and 1882 gave wives the right to keep their own earnings and property.\n\n"
            "🇷🇺 *Перевод:* До 1870 года имущество замужней женщины принадлежало мужу. Законы 1870 и 1882 гг. дали женщинам право на собственность и заработок."
        ),
    },
    {
        "question": "Which of the following is a traditional pub game in the UK?",
        "translation": "🇷🇺 Какая из следующих игр является традиционной пабной игрой в UK?",
        "options": [
            "A — Scrabble",
            "B — Pool",
            "C — Rounders",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Пул и дартс — традиционные игры в пабах. Викторины тоже популярны."
        ),
    },
    {
        "question": "TRUE or FALSE?\nKing Henry VIII established the Church of England when the Pope refused to grant him a divorce.",
        "translation": "🇷🇺 Верно или нет?\nГенрих VIII основал Церковь Англии, когда Папа отказал ему в разводе.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            ...
            "🇷🇺 *Перевод:* Генрих VIII основал Церковь Англии, когда Папа отказал ему в разводе с Екатериной Арагонской."
        ),
    },
    {
        "question": "TRUE or FALSE?\nBritish scientists were the first to clone a mammal successfully.",
        "translation": "🇷🇺 Верно или нет?\nБританские учёные первыми успешно клонировали млекопитающее.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            "📖 The British team was the first to succeed in cloning a mammal — Dolly the sheep.\n\n"
            "🇷🇺 *Перевод:* Британские учёные первыми клонировали млекопитающее — овцу Долли."
        ),
    },
    {
        "question": "What is a bank holiday?",
        "translation": "🇷🇺 Что такое «bank holiday»?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* «Bank holiday» — официальный выходной день, когда банки и многие предприятия закрыты."
        ),
    },
    {
        "question": "TRUE or FALSE?\nThere is a dragon on the official flag of Wales.",
        "translation": "🇷🇺 Верно или нет?\nНа официальном флаге Уэльса изображён дракон.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            "📖 Wales has its own flag, which shows a dragon. The Welsh dragon does not appear on the Union Flag because Wales was already united with England when the first Union Flag was created in 1606.\n\n"
            "🇷🇺 *Перевод:* На флаге Уэльса — дракон. Он не на флаге UK, так как Уэльс уже был объединён с Англией в 1606 году."
        ),
    },
    {
        "question": "Which country did Germany invade in 1939 that led to the UK declaring war on Germany?",
        "translation": "🇷🇺 Вторжение в какую страну в 1939 году привело к объявлению войны Германии со стороны UK?",
        "options": [
            "A — Austria",
            "B — Finland",
            "C — Poland",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* После вторжения Гитлера в Польшу в 1939 году Великобритания и Франция объявили войну Германии."
        ),
    },
    {
        "question": "Which TWO of the following is William Shakespeare famous for writing?",
        "translation": "🇷🇺 Чем ДВУМЯ из следующего знаменит Уильям Шекспир?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Шекспир (1564–1616) известен пьесами и поэзией, которые изучают по всему миру."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Черчилль был премьером с 1940 по 1945 год — во время Второй мировой войны."
        ),
    },
    {
        "question": "Which TWO of the following are British overseas territories?",
        "translation": "🇷🇺 Какие ДВЕ из следующих являются заморскими территориями Британии?",
        "options": [
            "A — Canada and Malaysia",
            "B — Falkland Islands and St Helena",
            "C — Falkland Islands and Malaysia",
            "D — Canada and St Helena"
        ],
        "answer": 1,
        "explanation": (
            "✅ *Верно — B!*\n\n"
            "📖 There are several British overseas territories, such as St Helena and the Falkland Islands. They are linked to the UK but are not a part of it.\n\n"
            "🇷🇺 *Перевод:* Острова Святой Елены и Фолклендские острова — заморские территории Британии."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            "✅ *Верно — A!*\n\n"
            "📖 After the Bill of Rights in 1689, there were two main groups in Parliament: the Whigs and the Tories. The modern Conservative Party is still sometimes referred to as the Tories.\n\n"
            "🇷🇺 *Перевод:* После Билля о правах 1689 года в Парламенте появились виги и тори. Консерваторов до сих пор называют тори."
        ),
    },
    {
        "question": "Which UK city hosted the 2012 Paralympic Games?",
        "translation": "🇷🇺 В каком городе UK прошли Паралимпийские игры 2012 года?",
        "options": [
            "A — Belfast",
            "B — Cardiff",
            "C — Edinburgh",
    ...
    },
    {
        ...
        "translation": "🇷🇺 Верно или нет?\nНекоторые люди арендуют участок («allotment»), где выращивают фрукты и овощи.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            ...
            "🇷🇺 *Перевод:* Некоторые британцы арендуют огородные участки («аллотменты»), где выращивают овощи и фрукты."
        ),
    },
    {
        "question": "When walking your dog in a public place, what must you ensure?",
        "translation": "🇷🇺 Что нужно обеспечить при выгуле собаки в общественном месте?",
        "options": [
    ...
    },
    {
        ...
        "translation": "🇷🇺 Верно или нет?\nУэльс объединился с Англией в период правления Генриха VIII.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
    ...
    },
    {
        ...
        "options": [
            ...
            "B — The UK is governed by the parliament sitting in Edinburgh."
        ],
        "answer": 0,
        "explanation": (
            "✅ *Верно — A!*\n\n"
            "📖 The UK is governed by the parliament sitting in Westminster. Scotland, Wales and Northern Ireland also have parliaments or assemblies of their own, with devolved powers.\n\n"
            "🇷🇺 *Перевод:* UK управляется парламентом в Вестминстере. У Шотландии, Уэльса и Северной Ирландии есть свои ассамблеи."
        ),
    },
    {
        "question": "What are TWO benefits of volunteering?",
        "translation": "🇷🇺 Какие ДВЕ выгоды даёт волонтёрство?",
        "options": [
            "A — You can earn additional money and you are given a courtesy car as transport.",
            "B — You can meet new people and you are given a courtesy car as transport.",
            "C — You can meet new people and you help to make your community a better place.",
            "D — You can earn additional money and you can meet new people."
        ],
        "answer": 2,
        "explanation": (
            "✅ *Верно — C!*\n\n"
            "📖 Volunteering is working for good causes without payment. Benefits include meeting new people and helping make your community a better place.\n\n"
            "🇷🇺 *Перевод:* Волонтёрство позволяет познакомиться с новыми людьми и сделать своё сообщество лучше."
        ),
    },
    {
        "question": "TRUE or FALSE?\nA traditional food in Wales is Ulster fry.",
        "translation": "🇷🇺 Верно или нет?\nАльстерская жареная еда (Ulster fry) — традиционное блюдо Уэльса.",
        "options": ["TRUE", "FALSE"],
        "answer": 1,
        "explanation": (
            "❌ *Неверно! / False!*\n\n"
            "📖 Ulster fry is a traditional food in Northern Ireland, not Wales. It is a fried meal with bacon, eggs, sausage, black pudding, soda bread and potato bread.\n\n"
            "🇷🇺 *Перевод:* Альстерская жарка — традиционное блюдо Северной Ирландии, а не Уэльса."
        ),
    },
    {
        "question": "Which TWO are famous British authors?",
        "translation": "🇷🇺 Кто из следующих ДВОЕ — знаменитые британские авторы?",
        "options": [
            "A — Mary Quant and Henry Moore",
            "B — Thomas Hardy and Graham Greene",
            "C — Thomas Hardy and Henry Moore",
            "D — Graham Greene and Henry Moore"
        ],
        "answer": 1,
        "explanation": (
            "✅ *Верно — B!*\n\n"
            "📖 Thomas Hardy\'s novels include Far from the Madding Crowd. Graham Greene\'s novels include Brighton Rock and Our Man in Havana.\n\n"
            "🇷🇺 *Перевод:* Томас Харди («Вдали от обезумевшей толпы») и Грэм Грин («Брайтонский леденец») — известные британские авторы."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Местные советы финансируются из центрального бюджета и местных налогов."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Уильям Блейк, лорд Байрон и Роберт Браунинг — поэты, а не гольфисты."
        ),
    },
    ],
t logging
...
TESTS = {
    ...
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* ООН создана после Второй мировой войны для предотвращения войн и поддержания мира."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
    ...
    },
    {
        ...
        "translation": "🇷🇺 Как называли сторонников Карла I во время Гражданской войны?",
        "options": [
            "A — Luddites",
            "B — Roundheads",
            "C — Cavaliers",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Сторонников короля называли кавалерами, сторонников Парламента — круглоголовыми."
        ),
    },
    {
        "question": "Which season of orchestral classical music has been organised by the BBC since 1927?",
        "translation": "🇷🇺 Какой сезон оркестровой классической музыки BBC организует с 1927 года?",
        "options": [
            "A — The Eisteddfod",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* «Промс» — восьминедельный летний сезон классической музыки, организованный BBC с 1927 года."
        ),
    },
    {
    ...
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Шамрок — символ Северной Ирландии. Чертополох — символ Шотландии."
        ),
    },
    {
        "question": "To apply for UK citizenship or permanent residency, which TWO things do you need?",
        "translation": "🇷🇺 Что из следующего нужно для гражданства или ПМЖ UK?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Для гражданства/ПМЖ нужно знание английского языка и жизни в UK."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Некоторые депутаты не представляют ни одну партию — их называют «независимыми»."
        ),
    },
    {
        "question": "Which TWO of the following were major welfare changes introduced from 1945 to 1950?",
        "translation": "🇷🇺 Какие ДВА важных социальных изменения были введены с 1945 по 1950 год?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Правительство лейбористов 1945 года создало NHS и национальную систему социальных пособий."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Люди железного века говорили на языке кельтской языковой семьи."
        ),
    },
    {
        "question": "Which TWO of the following are part of the UK government?",
        "translation": "🇷🇺 Что из следующего является частью правительства UK?",
        "options": [
    ...
    },
    {
        ...
        "translation": "🇷🇺 Кто первым построил Тауэр?",
        "options": [
            "A — Oliver Cromwell",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Тауэр впервые построил Вильгельм Завоеватель после восшествия на трон в 1066 году."
        ),
    },
    {
        "question": "TRUE or FALSE?\nThe criminal court systems in England, Wales, Scotland and Northern Ireland are identical.",
        "translation": "🇷🇺 Верно или нет?\nСистемы уголовных судов в Англии, Уэльсе, Шотландии и Северной Ирландии одинаковы.",
        "options": ["TRUE", "FALSE"],
        "answer": 1,
        "explanation": (
            "❌ *Неверно! / False!*\n\n"
            "📖 There are some differences between the criminal court systems in different parts of the UK.\n\n"
            "🇷🇺 *Перевод:* Системы уголовных судов в разных частях UK имеют различия."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Уимблдон — старейший теннисный турнир в мире."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
    ...
    },
    {
        ...
        "translation": "🇷🇺 Верно или нет?\nВ разных частях UK существуют значительные различия в языке.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            "📖 There are many variations in language in the different parts of the UK. In Wales, many people speak Welsh. In Scotland, Gaelic is spoken in some parts of the Highlands and Islands.\n\n"
            "🇷🇺 *Перевод:* В UK много языковых различий: валлийский в Уэльсе, гэльский в Шотландии и т.д."
        ),
    },
    {
    ...
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Реактивный двигатель и радар разработали в Британии в 1930-х, а не в 1830-х."
        ),
    },
    {
        "question": "What must you do in order to vote in elections?",
        "translation": "🇷🇺 Что нужно сделать, чтобы голосовать на выборах?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Для голосования необходимо быть внесённым в избирательный реестр."
        ),
    },
    {
        ...
        "translation": "🇷🇺 В какой период британской истории люди жили в круглых домах и хоронили мёртвых в курганах?",
        "options": [
            "A — The Middle Ages",
            "B — The Bronze Age",
            "C — The Stone Age",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Бронзовый век — около 4000 лет назад. Люди жили в круглых домах и хоронили мёртвых в курганах."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* UK — член НАТО, организации европейских и североамериканских стран взаимной обороны."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Римляне покинули Англию в 410 году н.э., пробыв там около 400 лет."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Фолклендские острова — одна из заморских территорий Британии."
        ),
    },
    ],
    16: [
    ...
    },
    {
        ...
        "translation": "🇷🇺 Верно или нет?\nТомас Харди — знаменитый автор, написавший «Вдали от обезумевшей толпы».",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            ...
            "🇷🇺 *Перевод:* Томас Харди (1840–1928) — автор романов о сельской жизни, включая «Вдали от обезумевшей толпы»."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Реформация — движение против власти Папы и Римско-католической церкви."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            "✅ *Верно — A!*\n\n"
            "📖 UK laws ensure people are not treated unfairly because of pregnancy and maternity. Pregnant women have the same right to work as anyone else.\n\n"
            "🇷🇺 *Перевод:* Законы UK запрещают дискриминацию по беременности. Беременные женщины имеют те же права на работу."
        ),
    },
    {
        "question": "Hadrian's Wall was built to keep out whom?",
        "translation": "🇷🇺 Для защиты от кого был построен Вал Адриана?",
        "options": [
            "A — The Irish",
            "B — The Welsh",
            "C — The Picts",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Вал Адриана построили для защиты от пиктов — предков шотландцев."
        ),
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Викинги впервые напали на Британию в 789 году н.э. Они пришли из Дании, Норвегии и Швеции."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Волонтёрство — помощь другим без оплаты. Можно помогать бездомным, улучшать экологию и т.д."
        ),
    },
    {
        "question": "TRUE or FALSE?\nPeople can see the Crown Jewels at the Tower of London.",
        "translation": "🇷🇺 Верно или нет?\nКоронные драгоценности можно увидеть в Тауэре.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
            "📖 People can see the Crown Jewels at the Tower of London.\n\n"
            "🇷🇺 *Перевод:* Коронные драгоценности хранятся и выставлены в Тауэре."
        ),
    },
    {
        "question": "For which TWO types of literature is William Shakespeare famous?",
        "translation": "🇷🇺 Какими ДВУМЯ видами литературы знаменит Шекспир?",
        "options": [
            "A — Plays and sonnets",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Шекспир знаменит своими пьесами и сонетами."
        ),
    },
    {
        "question": "For which TWO reasons is Henry VIII remembered?",
        "translation": "🇷🇺 За что ДВЕ вещи помнят Генриха VIII?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Генрих VIII известен разрывом с Римской церковью и шестью браками."
        ),
    },
    {
        "question": "For approximately how many years did the Romans remain in Britain?",
        "translation": "🇷🇺 Примерно сколько лет римляне оставались в Британии?",
        "options": [
            "A — 50 years",
            "B — 100 years",
            "C — 400 years",
    ...
    },
    {
        ...
        "translation": "🇷🇺 Верно или нет?\nВ последние годы рост населения UK ускорился.",
        "options": ["TRUE", "FALSE"],
        "answer": 0,
        "explanation": (
            "✅ *Верно! / True!*\n\n"
    ...
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* При покупке автомобиля нужно платить ежегодный транспортный налог — он не переходит от предыдущего владельца."
        ),
    },
    {
        "question": "The Union Flag consists of three crosses. One is the cross of St George. Who do the other TWO crosses represent?",
        "translation": "🇷🇺 Флаг UK состоит из трёх крестов. Один — Св. Георгия. Кого представляют остальные ДВА?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Флаг UK содержит кресты Святых Георгия, Андрея и Патрика."
        ),
    },
    {
        "question": "Which of the following statements is correct?",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* В мае 1660 года Парламент призвал Карла из изгнания, и он был коронован Карлом II."
        ),
    },
    {
        "question": "Which TWO of the following types of case are held in Crown Courts?",
        "translation": "🇷🇺 Какие ДВА типа дел рассматриваются в Суде Короны?",
        "options": [
            "A — Theft and murder",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Суды Короны рассматривают серьёзные уголовные дела — кражи, убийства и т.д."
        ),
    },
    {
        "question": "Which is a famous landmark in Wales?",
        "translation": "🇷🇺 Какая из следующих достопримечательностей находится в Уэльсе?",
        "options": [
            "A — Snowdonia",
    ...
    },
    {
        ...
        "translation": "🇷🇺 Какой праздник отмечается каждый год 14 февраля?",
        "options": [
            "A — Valentine's Day",
            "B — Bonfire Night",
            "C — Halloween",
        ...
        "explanation": (
            "✅ *Верно — A!*\n\n"
            "📖 Valentine\'s Day, on 14 February, is when lovers exchange cards and gifts.\n\n"
            "🇷🇺 *Перевод:* 14 февраля — День Святого Валентина, когда влюблённые обмениваются открытками и подарками."
        ),
    },
    {
        "question": "Which TWO of the following were British inventions?",
        "translation": "🇷🇺 Какие ДВА из следующего были британскими изобретениями?",
        "options": [
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Телевидение и реактивный двигатель — важные британские изобретения 20 века."
        ),
    },
    {
    ...
    },
    {
        ...
        "translation": "🇷🇺 Какие страны составляют «Великобританию»?",
        "options": [
            "A — Just England",
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* «Великобритания» — это только Англия, Шотландия и Уэльс. Северная Ирландия — отдельная часть UK."
        ),
    },
    {
        ...
        "explanation": (
            "✅ *Верно — B!*\n\n"
            "📖 Welsh cakes are a traditional Welsh snack. Haggis is a traditional Scottish food made from a sheep\'s stomach stuffed with offal, suet, onions and oatmeal.\n\n"
            "🇷🇺 *Перевод:* Уэльские лепёшки — традиционная закуска Уэльса. Хаггис — традиционное шотландское блюдо."
        ),
    },
    {
    ...
    },
    {
        ...
        "explanation": (
            ...
            "🇷🇺 *Перевод:* Нормандские острова тесно связаны с UK, но не входят в его состав — это зависимые территории Короны."
        ),
    },
    ],
