...
"🇷🇺 *Перевод:* Большинство граждан UK, Ирландии или Содружества в возрасте 18+ могут баллотироваться на публичную должность."
),
},
{
...
"explanation": (
"✅ *Верно — D!*\n\n"
"📖 In England, Wales and Northern Ireland, serious offences are tried in a Crown Court. In Scotland, serious cases are heard in a Sheriff Court.\n\n"
"🇷🇺 *Перевод:* Серьёзные преступления рассматриваются в судах Короны (Англия/Уэльс/СИ) и судах шерифов (Шотландия)."
),
},
{
...
"🇷🇺 *Перевод:* Продажа алкоголя лицам младше 18 лет является уголовным преступлением."
),
},
{
...
"🇷🇺 *Перевод:* Здания Парламента и вокзал Сент-Панкрас построены в неоготическом стиле 19 века."
),
},
{
...
"explanation": (
"✅ *Верно! / True!*\n\n"
"📖 In 1588, the English defeated the Spanish Armada — a large fleet of ships sent by Spain to conquer England.\n\n"
...
"explanation": (
"✅ *Верно — D!*\n\n"
"📖 In the UK, Mothering Sunday is celebrated three weeks before Easter and Father\'s Day on the third Sunday in June.\n\n"
"🇷🇺 *Перевод:* В UK отмечается День матери (за 3 недели до Пасхи) и День отца (3-е воскресенье июня)."
),
},
{
"question": "How old do you have to be to go into a betting shop in the UK?",
"translation": "🇷🇺 Сколько лет нужно, чтобы войти в букмекерскую контору в UK?",
"options": [
"A — 21",
"B — 18",
"C — 25",
...
"🇷🇺 *Перевод:* Для входа в букмекерские конторы и игорные клубы необходимо быть старше 18 лет."
),
},
{
"question": "Which of the following statements is correct?",
...
"explanation": (
"✅ *Верно — B!*\n\n"
"📖 Gilbert and Sullivan wrote comic operas, often making fun of popular culture and politics. These include HMS Pinafore, The Pirates of Penzance and The Mikado.\n\n"
...
"explanation": (
"✅ *Верно! / True!*\n\n"
"📖 British society is founded on fundamental values and principles, which are based on history and traditions.\n\n"
...
"🇷🇺 *Перевод:* «Разум и чувство» — роман Джейн Остен. Другие: «Гордость и предубеждение»."
),
},
{
...
"explanation": (
"✅ *Верно — C!*\n\n"
"📖 It is important to recycle as much of your waste as you can. Walking and using public transport is also a good way to protect the environment.\n\n"
"🇷🇺 *Перевод:* Переработка мусора и использование общественного транспорта помогают защитить окружающую среду."
),
},
{
...
"explanation": (
"✅ *Верно — B!*\n\n"
"📖 In 1918, women over the age of 30 were given voting rights. In 1928, women were given the right to vote at 21, the same as men.\n\n"
"🇷🇺 *Перевод:* В 1918 году женщины старше 30 лет получили право голоса. В 1928 — с 21 года."
),
},
{
"question": "TRUE or FALSE?\nIn 1921 a peace treaty was signed which led to Ireland becoming two countries.",
"translation": "🇷🇺 Верно или нет?\nВ 1921 году был подписан мирный договор, разделивший Ирландию на два государства.",
"options": ["TRUE", "FALSE"],
"answer": 0,
"explanation": (
"✅ *Верно! / True!*\n\n"
"📖 In 1921 a peace treaty was signed and in 1922 Ireland became two countries: Northern Ireland and the Irish Free State.\n\n"
...
"translation": "🇷🇺 Верно или нет?\nДжон Констебл (1776–1837) основал современную полицию в Англии.",
"options": ["TRUE", "FALSE"],
"answer": 1,
"explanation": (
"❌ *Неверно! / False!*\n\n"
"📖 John Constable was a landscape painter most famous for his works of Dedham Vale.\n\n"
...
"explanation": (
"✅ *Верно — C!*\n\n"
"📖 In 1940, civilian volunteers in small boats helped the Navy rescue 300,000 men from the beaches around Dunkirk.\n\n"
...
"🇷🇺 *Перевод:* При уходе депутата проводятся дополнительные выборы (by-election) в его округе."
),
},
{
